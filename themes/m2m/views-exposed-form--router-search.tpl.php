...
<div class="deviceSearch">
    <h2>Router Search</h2>
     ...
     Select from the following options to search the router database. Press and hold the Ctrl button to select multiple items.
     <div><?php echo l('View All', 'routersearch');?></div>
     </div>
